...
Partition key `2c8dbf9f-db4f-41ef-a62c-beac1c8f6384` — pass this as `brand` to the Hub's API, and read only this directory.

10 atoms in this directory, 10 of them global on all four axes. Retired and draft
...
|---|---|---|
| [`image guidelines`](image-guidelines.md) | 10 | `photographic_style` 2, `composition_and_framing` 3, `subject_and_diversity` 2, `color_direction` 1, `visual_tokens` 1, `misc` 1 |
