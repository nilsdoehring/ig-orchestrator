...
Partition key `7f29907c-2b09-4034-a78e-c920230b1599` — pass this as `brand` to the Hub's API, and read only this directory.

11 atoms in this directory, 11 of them global on all four axes. Retired and draft
...
|---|---|---|
| [`image guidelines`](image-guidelines.md) | 11 | `photographic_style` 3, `composition_and_framing` 2, `subject_and_diversity` 3, `color_direction` 1, `visual_tokens` 1, `misc` 1 |
