...
subject: knowledge/rules/typography.md
team: IONOS
...
21 rules. Modality is the contract: **must** is never dropped, **should** and **may** yield to the budget in that order.

### `punctuation.quotes_product_pages`

**[SHOULD]** Avoid using quotation marks on product pages (headlines, CTAs, badges, meta data, product descriptions); use bold text or links for emphasis instead.

- **Caveat:** Typographical quotation marks are primarily used in customer quotes/testimonials, Digital Guide/editorial content, FAQ answers (for product names/UI references), and press releases. When in doubt, use bold instead of quotation marks on product pages.
- **Why:** On IONOS product pages, quotation marks are rarely used.
- **Scope:** language es-MX (specificity 1)
- **Slots:** badge, cta_button, headline, info_text
- **Channels:** web
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Source:** `section Anführungszeichen`

### `typography.alignment_left`

**[MUST]** Always align text left.

- **Caveat:** Centered text only works in limited settings, e.g. in CTA buttons and in headlines in special layouts.
- **Why:** Flush left creates strong alignments for the eyes to follow, aiding readability and organization. It is functional, modern and the most effective format in information design.
- **Slots:** body_text, bullet, info_text
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Source:** `section Typography: Fundamentals, page 21`

### `typography.avoid_widows_orphans`

**[SHOULD]** Avoid widows and orphans in paragraphs.

- **Why:** A single word hanging at the end of a paragraph is quite distracting and should be avoided.
- **Slots:** body_text
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Typography: Fundamentals, page 21`

### `typography.color_diminished_contrast`

**[SHOULD]** Use diminished contrast for supplemental information such as accompanying text or features to the primary content.

- **Slots:** info_text, tooltip
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Typography: Using Colors, page 20`

### `typography.color_neutral_default`

**[SHOULD]** Use neutral colors as the default for main titles and body text, preferring K100 for print materials.

- **Slots:** body_text, headline
- **Channels:** print, web
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Typography: Using Colors, page 20`

### `typography.cta_bold_instead_of_quotes`

**[MUST]** Verwenden Sie bei der Beschreibung von Aktionen keine Anführungszeichen zur Kennzeichnung von CTAs, sondern stattdessen den Fettdruck.
...
### `typography.line_length`

**[SHOULD]** Keep the line length to an optimum range of between 30 to 80 characters.

- **Why:** To create better-looking rags on the right margin of your paragraph.
- **Slots:** body_text, info_text
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Typography: Fundamentals, page 21`

### `typography.no_bold_in_body`

**[MUST]** Verwenden Sie keine Fettmarkierungen (<b>/<strong>) im Fließtext-Content.

- **Caveat:** Ausnahme: Headlines, Navigation, UI-Labels.
...
### `typography.no_callout_colors_for_non_callouts`

**[MUST]** Do not use callout colors (such as error, success, and warning colors) for non-callout text.
...
### `typography.no_random_hues`

**[MUST]** Do not use random hues or tints for text.

- **Why:** Colored texts kill functional colors. Color is not for decoration.
- **Scope:** all channels (asserted by the source) · all slots (asserted by the source) (specificity 0)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Source:** `section Typography: Using Colors, page 20`

### `typography.no_text_gradients`

**[MUST]** Do not use text gradients.
...
### `typography.product_page_emphasis`

**[SHOULD]** Avoid using quotation marks on product pages (headlines, CTAs, badges, meta data, product descriptions); use bold text or links for emphasis instead.

- **Caveat:** Typographic quotation marks are acceptable in customer testimonials, Digital Guide/editorial content, FAQ answers (for product names/UI references), and press releases. In case of doubt, use bold instead of quotes on product pages.
- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** Quotation marks are rarely used on live IONOS product pages.
...
**[SHOULD]** On product pages, avoid using quotation marks; instead, emphasize terms using bold text or links.

- **Caveat:** Typographical quotes are primarily reserved for customer testimonials, Digital Guide/editorial content, FAQ answers (referencing product names/UI), and press releases.
- **Why:** Quotation marks are rarely used on live IONOS product pages (headlines, CTAs, badges, metadata, product descriptions).
...
**[SHOULD]** On product pages, avoid quotation marks and use bold text or links for emphasis instead.

- **Caveat:** Typographical quotes are acceptable in customer quotes/testimonials, digital guide/editorial content, FAQ answers, and press releases.
- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** Quotation marks are rarely used on IONOS product pages (headlines, CTAs, badges, meta data, product descriptions).
- **Scope:** language fr-FR (specificity 1)
- **Slots:** badge, body_text, cta_button, headline, info_text
- **Channels:** web
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Source:** `section Anführungszeichen, page 1`

### `typography.quotes_avoid_product_pages`

**[SHOULD]** Avoid using quotation marks on product pages (headlines, CTAs, badges, meta data, product descriptions); use bold formatting or links instead.

- **Caveat:** Typographical quotation marks are primarily used in customer testimonials, Digital Guide/editorial content, FAQ answers (for product names/UI references), and press releases.
- **Why:** On IONOS product pages, quotation marks are rarely used; instead, terms are highlighted in bold or as links.
...
### `typography.quotes_avoidance`

**[SHOULD]** Verwenden Sie auf Produktseiten (Headlines, CTAs, Badges, Meta-Daten, Produktbeschreibungen) im Zweifel Fettmarkierungen oder Links statt Anführungszeichen.

- **Caveat:** Typografische Anführungszeichen kommen v. a. in Kundenzitaten/Testimonials, Digital-Guide-/redaktionellen Inhalten, FAQ-Antworten (bei Produktnamen/UI-Referenzen) und Pressemeldungen vor.
- **Why:** Auf IONOS-Produktseiten werden Anführungszeichen kaum verwendet.
...
### `typography.quotes_primary`

**[MUST]** Use angle quotes «…» as the primary quotation marks.
...
### `typography.quotes_secondary`

**[MUST]** Use straight double quotes "…" as the secondary quotation marks.
...
### `typography.registered_trademark`

**[SHOULD]** Das eingetragene Markensymbol ® sollte hinter bestimmten geschützten Marken wie Microsoft und Intel erscheinen und immer hochgestellt sein.

- **Caveat:** Informiere dich auf den Websites der einzelnen Unternehmen, wie dort der Markenname genutzt wird.
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Checked, not instructed:** verified against the output by `/check`. Costs no prompt budget.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Symbole, page 19`

### `typography.registered_trademark_symbol_superscript`

**[SHOULD]** Das eingetragene Markensymbol ® sollte hinter bestimmten geschützten Fremdmarken (z.B. Microsoft, Intel) erscheinen und immer hochgestellt sein — informiere dich, wie der jeweilige Markenname vom Unternehmen selbst genutzt wird.
