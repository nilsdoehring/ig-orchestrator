...
subject: knowledge/rules/product-naming-governance.md
team: IONOS
...
**[MUST]** Use 'IONOS' as the official company name.
...
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Channels:** display_ad, email, newsletter, print, showroom, social, tv, web
- **Source:** `section Markenregeln, page 1`

### `brand.company_name`

**[MUST]** Always write the company name as 'IONOS'.
...
**[MUST]** Use 'IONOS' as the company name.
...
### `brand.open_source_naming`

**[MUST]** Do not translate open-source names like 'n8n' or 'OpenClaw'. Treat them as product names in body text.

- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** These are open-source proper names.
- **Scope:** language en-CA · all channels (asserted by the source) · all languages (asserted by the source) · all markets (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** body_text
- **Source:** `section KI / AI / IA – Terminologieregeln, page 3`

### `brand.possessive`

**[MUST]** Use 'X from IONOS' or 'IONOS X' to express possession.
...
### `brand.untranslated_names`

**[MUST]** Do not translate the following names: Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** These are proprietary brand names, open-source product names, or third-party trademarks that must remain identical in all markets.
- **Scope:** language en-CA · all channels (asserted by the source) · all languages (asserted by the source) · all markets (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
...
**[MUST]** Do not translate brand and third-party proper names, including: Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao.
...
### `product_naming.mywebsite_now_global`

**[MUST]** Verwenden Sie in allen Märkten den Produktnamen 'MyWebsite Now'.

- **Scope:** all markets (asserted by the source) (specificity 0)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Zielmärkte, page 1`

### `product_naming.rankingcoach_global`

**[MUST]** Der Produktname 'rankingCoach' muss in allen IONOS Märkten identisch verwendet werden.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** Der Produktname ist in allen IONOS Märkten identisch.
- **Scope:** all markets (asserted by the source) (specificity 0)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Zielmärkte, page 2`

### `product_naming_governance.ai_model_hub`

**[MUST]** Keep 'AI Model Hub' in English across all markets (e.g., 'AI Model Hub de IONOS').

- **Why:** It remains in English in all markets.
...
**[MUST]** Keep "AI Model Hub" in English across all markets (e.g., "AI Model Hub de IONOS" / "AI Model Hub d'IONOS").
...
### `product_naming_governance.ai_products`

**[MUST]** Use the approved English product names for AI tools (e.g., AI Website Generator, AI Text Generator, AI Image Generator, AI SEO Assistant, AI Domain Name Generator, AI Colour Palette Generator, AI Tools, AI Email Assistant, AI Model Hub, AI Phone Assistant, AI Text Optimiser).
...
### `product_naming_governance.cloud_ionos`

**[MUST]** Always write "Cloud IONOS" instead of "IONOS Cloud" to follow French style guide word order.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** FR-Style-Guide-spezifische Wortstellung.
- **Scope:** language fr-FR · all channels (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln, page 2`

### `product_naming_governance.do_not_translate`

**[MUST]** Do not translate brand names and third-party names including Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** These are proper names and must remain identical in all markets.
- **Scope:** language es-MX (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Eigennamen (nie übersetzen)`

### `product_naming_governance.imc_ticket_and_brand_approval_required`

**[MUST]** Neue Produkt-/Tarifnamen müssen ein IMC-Ticket durchlaufen; Namensvorschläge des Lokalisierungsteams müssen Brand Approval erhalten, bevor sie genutzt werden können.
...
- **Source:** `Style Guide DEU.md:350-354`

### `product_naming_governance.open_source_names`

**[MUST]** Keep open-source names like 'n8n' and 'OpenClaw' unchanged and treat them as product names in body text.

- **Why:** They are open-source proper names.
- **Scope:** language es-MX (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section KI / AI / IA – Terminologieregeln`
...
**[MUST]** Never translate open-source names like "n8n" or "OpenClaw". Treat them as product names in running text.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** Open-Source-Eigennamen, nie übersetzen.
- **Scope:** language fr-FR · all channels (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section KI / AI / IA – Terminologieregeln, page 3`

### `product_naming_governance.untranslated_names`

**[MUST]** Never translate the following brand, open-source, and third-party names: Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao, Docker, Kubernetes.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** These names must remain identical across all markets.
- **Scope:** language fr-FR · all channels (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Eigennamen (nie übersetzen), page 3`

### `product_offering.no_enterprise`

**[MUST]** IONOS verkauft nicht das Enterprise-Paket von Google Workspace.

- **Scope:** all products (asserted by the source) (specificity 0)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Zielpublikum/Segmentierung, page 1`

### `terminology.ai_model_hub`

**[MUST]** Keep 'AI Model Hub' in English across all markets.
...
### `terminology.dedicated_server_packages`

**[MUST]** Vermeiden Sie die Begriffe 'Pakete' oder 'Pläne' beim Kauf eines Dedicated Servers.

- **Why:** Kunden erhalten den gesamten Server mit einem Datenplan.
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Terminologie/Stilrichtlinien, page 3`

### `terminology.google_brand_guidelines`

**[MUST]** Die Markenrichtlinien von Google müssen beachtet werden.

- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Human track only:** no prompt can satisfy this — it asks for an action outside text generation. Never inject it as an instruction.
- **Source:** `section Terminologie/Styleguide, page 3`
