...
subject: knowledge/rules/terminology.md
team: IONOS
...
12 rules. Modality is the contract: **must** is never dropped, **should** and **may** yield to the budget in that order.

### `terminology.ai_adjective_form`

**[MUST]** Use 'basado en IA' or 'con IA' as the Spanish adjective form for AI-based/with AI.
...
### `terminology.ai_model_hub_untranslated`
...
### `terminology.alojamiento_allowed`

**[MAY]** The hosting synonym 'alojamiento' is allowed.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.avoid_datacenters`

**[MUST]** Avoid using 'Data centers'; use 'centros de datos' instead.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.avoid_eshop`

**[MUST]** Avoid using 'e-shop'; use 'tienda online' instead.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.avoid_georredundante`

**[MUST]** Avoid using 'georredundante'; use 'geográficamente redundante' instead.
...
**[MUST]** Use 'RGPD' for the General Data Protection Regulation.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.gratis_not_zero_euros`

**[MUST]** Always use 'gratis' instead of '0 €' or '$0' on all pages.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.n8n_openclaw_untranslated`

**[MUST]** Do not translate open-source names 'n8n' and 'OpenClaw'; treat them as product names in running text.

- **Scope:** language es-ES (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section KI / AI / IA – Terminologieregeln`

### `terminology.pack_for_tariffs`

**[MUST]** Use 'pack(s)' for tariffs/plans.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.prefer_correo_electronico`

**[SHOULD]** Prefer 'Correo electrónico' over 'e-mail' and 'comercio electrónico' over 'e-commerce'.

- **Scope:** language es-ES · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `terminology.untranslated_names`

**[MUST]** Do not translate specific brand/product names: Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** These are open-source or third-party brand names that must remain identical in all markets.
- **Scope:** language es-ES (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
