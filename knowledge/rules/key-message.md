...
subject: knowledge/rules/key-message.md
team: IONOS
...
14 rules. Modality is the contract: **must** is never dropped, **should** and **may** yield to the budget in that order.

### `key_message.european_origin`

**[MUST]** Do not hide our European origin; instead, highlight virtues associated with it, such as social market economy, sustainability, and data protection.

- **Why:** These virtues are great arguments for customers to identify with the IONOS brand and mirror their self-image of independence.
...
- **Source:** `section Hero Story, page 1, line 21`

### `key_message.green_energy`

**[SHOULD]** Kommuniziere das Thema grüne Energie abhängig von der Verfügbarkeit im Zielmarkt und fokussiere es besonders bei der Zielgruppe des WordPress Hostings (Kreative).

- **Caveat:** Abhängig von der Verfügbarkeit im Zielmarkt.
- **Why:** Grüne Energie ist am relevantesten für die Zielgruppe des WordPress Hosting, wo Kreative die größte Zielgruppe bilden.
- **Slots:** body_text, bullet
- **Channels:** web
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section KSPs | Key Messages, page 2`

### `key_message.simplicity_framing`

**[SHOULD]** Stelle Webhosting nicht als komplett voraussetzungsfreie 'einfache' Lösung dar, sondern betone die 1-Klick-Installation und die Erleichterung im Vergleich zu Server-Produkten (keine eigene Instandhaltung/Updates).

- **Why:** Webhosting erfordert dennoch ein gewisses technisches Grundwissen, ist aber im Vergleich zu Servern unkomplizierter.
...
### `key_message.web_hosting_ksp1_security_reliability`

**[SHOULD]** Kommuniziere Sicherheit und Verlässlichkeit: Malware- und DDoS-Schutz, Georedundanz, ISO-zertifizierte Rechenzentren, Backups, branchenführende Betriebszeiten.

- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:52-53`

### `key_message.web_hosting_ksp2_customer_service`

**[SHOULD]** Kommuniziere Kundenservice: 24/7-Erreichbarkeit, Unterstützung durch einen persönlichen Berater.

- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:54-55`

### `key_message.web_hosting_ksp3_speed`

**[SHOULD]** Kommuniziere Schnelligkeit: SSD-Speicher, Hochgeschwindigkeits-Glasfaserverbindungen, Content Delivery Network (CDN).

- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:56-57`

### `key_message.web_hosting_ksp4_ease_of_use`

**[SHOULD]** Kommuniziere einfache Anwendung: 1-Klick-Installation inkl. Domain, E-Mail-Postfach und SSL. Wichtig: Webhosting ist keine Lösung ohne jede technische Kenntnis — die 1-Klick-Installation ist lediglich unkomplizierter als ein Server-Produkt, bei dem der Nutzer sich selbst um Instandhaltung kümmern muss.

- **Caveat:** Webhosting ist keine "einfache" Lösung in dem Sinne, dass der Nutzer keinerlei technische Kenntnisse benötigt.
- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:58-60`

### `key_message.web_hosting_ksp5_price_performance`

**[SHOULD]** Kommuniziere ein gutes Preis-Leistungs-Verhältnis.

- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:61`

### `key_message.web_hosting_ksp6_scalable_performance`

**[SHOULD]** Kommuniziere skalierbare Performance-Level: Nutzer können bei Bedarf Speicherplatz hinzufügen.

- **Scope:** product Web Hosting (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:62`

### `key_message.web_hosting_ksp7_green_energy`

**[SHOULD]** Kommuniziere grüne Energie als Vorteil, sofern im Zielmarkt verfügbar; am relevantesten für die Zielgruppe des WordPress Hosting, wo Kreative die größte Zielgruppe bilden.

- **Caveat:** Abhängig von der Verfügbarkeit im Zielmarkt.
- **Scope:** product Web Hosting · market DE · audience migrated.freelancer_agenturen (specificity 14)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Only when:** `{"market_availability":"available"}`
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `Comms Guide DE Web Hosting.md:63-64`

### `ksp.easy_use_framing`

**[SHOULD]** Kommuniziere Webhosting nicht als 'einfache' Lösung im Sinne von 'keinerlei technische Kenntnisse nötig', sondern betone die unkomplizierte 1-Klick-Installation und den Vorteil, dass Instandhaltung und Updates entfallen.

- **Why:** Webhosting erfordert ein Minimum an technischem Vorwissen, ist aber im Vergleich zu Server-Produkten wartungsfrei.
- **Scope:** product Web Hosting (specificity 8)
- **Slots:** body_text, bullet, info_text
- **Channels:** email, newsletter, web
- **Source:** `section KSPs | Key Messages, page 1`

### `ksp.green_energy_context`

**[SHOULD]** Nutze das KSP 'Grüne Energie' primär im Kontext von WordPress Hosting für kreative Zielgruppen und stelle sicher, dass es im jeweiligen Zielmarkt verfügbar ist.

- **Caveat:** Abhängig von der Verfügbarkeit im Zielmarkt.
- **Why:** Grüne Energie ist am relevantesten für die Zielgruppe des WordPress Hosting, wo Kreative die größte Zielgruppe bilden.
- **Slots:** body_text, bullet
- **Channels:** newsletter, web
- **Source:** `section KSPs | Key Messages, page 1`

### `market.gdpr_not_main_usp`

**[SHOULD]** Erwähnen Sie die DSGVO-Konformität, aber machen Sie sie nicht zum Haupt-Verkaufsargument.

- **Scope:** product Nextcloud (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Zielmärkte, page 2`

### `product_limitations_messaging`

**[MUST]** Positionieren Sie das Produkt nicht für hochgradig individualisierte Websites, HTML-Anpassungen, Blogbeiträge, externe Add-ons oder mobiles Editieren.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** Das Produkt eignet sich für diese Anwendungsfälle eher nicht.
