...
subject: knowledge/rules/localization.md
team: IONOS
...
**[MUST]** Format dates as 'DD de mes de AAAA', e.g., '28 de abril de 2025'.
...
**[MUST]** Der Produktname 'AI Model Hub' bleibt in allen Märkten auf Englisch (z. B. 'AI Model Hub von IONOS').
...
**[MUST]** Behalten Sie die Open-Source-Eigennamen 'n8n' und 'OpenClaw' unverändert bei.
...
**[MUST]** Use "X d'IONOS" or "X de IONOS" for the possessive form of IONOS.
...
### `legal.privacy_framework`

**[MUST]** Use the CCPA reference framework for privacy compliance in CA.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** No specific Canadian privacy law is documented in the source.
- **Scope:** language en-CA · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Rechtliches & Formate, page 3`

### `localization.ai_model_hub`

**[MUST]** Keep 'AI Model Hub' in English across all markets (e.g., 'AI Model Hub von IONOS', 'AI Model Hub de IONOS').

- **Exhaustive:** this list is complete. Do not extend it.
- **Scope:** language en-GB · all channels (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section KI / AI / IA – Terminologieregeln, page 1`

### `localization.date_format`

**[MUST]** Formatieren Sie das Datum im Muster TT.MM.JJJJ (z. B. 28.04.2025).
...
**[MUST]** Format dates as 'Month Day, Year' (e.g., October 24, 2024).

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** CA uses the same date format as the US.
- **Scope:** language en-CA · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Rechtliches & Formate, page 3`
...
**[MUST]** Format dates as Day Month Year (e.g., 28 April 2025) without commas.

- **Exhaustive:** this list is complete. Do not extend it.
- **Scope:** language en-GB · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln, page 1`

### `localization.date_format`

**[MUST]** Format dates as 'Month Day, Year' (e.g., April 28, 2025).
...
**[MUST]** Format dates as "JJ mois AAAA" (e.g., 28 avril 2025).
...
### `localization.date_format_legal`

**[MUST]** Verwenden Sie das Datumsformat TT.MM.JJJJ.

- **Exhaustive:** this list is complete. Do not extend it.
- **Scope:** language de-DE · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Rechtliches & Formate, page 5`

### `localization.do_not_translate_brands`

**[MUST]** Übersetzen Sie Eigennamen von IONOS-Produkten, Open-Source-Projekten und Drittanbietern nicht (z. B. Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao, Docker, Kubernetes).

- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** Diese Namen sind in allen Märkten identisch.
- **Scope:** language de-DE (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Eigennamen (nie übersetzen), page 5`

### `localization.do_not_translate_proper_names`

**[MUST]** Do not translate brand names and third-party proper names (e.g., Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, Contao, Docker, Kubernetes) in any market.

- **Exhaustive:** no — the source presents this as illustrative.
- **Scope:** language en-GB · all channels (asserted by the source) · all slots (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Eigennamen (nie übersetzen), page 1`

### `localization.dsgvo`

**[MUST]** Verwenden Sie im deutschen Markt die Abkürzung 'DSGVO' anstelle von 'GDPR'.

- **Why:** Datenschutz-Gesetz im deutschen Markt.
- **Scope:** language de-DE · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln, page 2`

### `localization.dsgvo_legal`

**[MUST]** Verwenden Sie als Bezeichnung für das Datenschutz-Gesetz 'DSGVO'.
...
### `localization.navigation_structure`

**[SHOULD]** Follow the UK navigation structure for CA, applying US-specific spelling where it differs.

- **Caveat:** This is a guideline to address a source gap.
- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** There is a source gap for CA in the source table; CA/US generally follow the UK structure with US spelling.
- **Scope:** language en-CA (specificity 1)
- **Slots:** nav_label
- **Channels:** web
...
- **Source:** `section Navigation, page 1`

### `localization.open_source_names`

**[MUST]** Do not translate open-source product names like 'n8n' or 'OpenClaw'; treat them as product names in body text.
...
### `localization.plan_vs_package`

**[MUST]** Use the term 'plan(s)' instead of 'package(s)' to refer to tariffs in the US market.

- **Scope:** language en-US · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln, page 2`

### `localization.privacy_law`

**[MUST]** Refer to CCPA (California Consumer Privacy Act) instead of GDPR for privacy law contexts in the US.
...
**[MUST]** Use 'LFPDPPP' as the privacy law abbreviation instead of 'RGPD'.

- **Scope:** language es-MX · all languages (asserted by the source) · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln`

### `localization.product_english_only`

**[MUST]** Das Produkt nur in englischer Sprache anbieten (nicht lokalisieren), während Marketing und Werbemittel lokalisiert werden.

- **Why:** Das Produkt ist nur in englischer Sprache erhältlich.
- **Scope:** all products (asserted by the source) (specificity 0)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Zielmärkte, page 1`

### `localization.product_terminology_baseline`

**[MUST]** Use UK terminology as a starting point for CA, but apply US deviations such as 'plan(s)' instead of 'package(s)', 'Data Center' instead of 'Data Centre', and US spelling (-ize/-or/-er).

- **Caveat:** Product names in AI section 11.2 are not affected by this baseline and are provided separately.
- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** There is a source gap for CA in the source table; UK is the baseline with US-specific modifications.
- **Scope:** language en-CA (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Produkt-Terminologie, page 2`

### `localization.product_terminology_baseline`

**[SHOULD]** Use the UK product terminology as a baseline for US/CA, applying US spelling deviations (e.g., 'plan(s)' instead of 'package(s)', 'Data Center' instead of 'Data Centre', and '-ize/-or/-er' spellings).

- **Caveat:** This baseline rule does not apply to AI product names, which are documented separately.
- **Why:** Source gap: US does not have its own column in the source product terminology table.
- **Scope:** language en-US (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Human track only:** no prompt can satisfy this — it asks for an action outside text generation. Never inject it as an instruction.
- **Source:** `section Produkt-Terminologie, page 2`

### `localization.proper_names_untranslated`

**[MUST]** Do not translate brand and product proper names, including Momentum, MyWebsite Now, Presence Suite, rankingCoach, SiteAnalytics, HiDrive, MyDefender, Deploy Now, n8n, OpenClaw, Google Workspace, Microsoft 365, WordPress, WooCommerce, PrestaShop, Joomla!, and Contao.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** These are proper names and must remain identical across all markets.
- **Scope:** language en-US · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Eigennamen (nie übersetzen), page 3`

### `localization.tax_claim`

**[MUST]** Use the phrase 'Plus applicable tax' for tax/VAT claims.
...
### `localization.us_ca_differences`

**[MUST]** Actively check for product differences between US and CA (e.g., .ca domain offers) before copying US content 1:1.

- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** Product offerings may differ between the US and CA markets.
- **Scope:** language en-CA (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Human track only:** no prompt can satisfy this — it asks for an action outside text generation. Never inject it as an instruction.
- **Source:** `section Weitere markttypische Regeln, page 2`

### `localization.us_spelling_and_formats`

**[MUST]** Use US spelling (-ize/-or/-er), the CCPA privacy framework, and the 'Month Day, Year' date format.

- **Exhaustive:** this list is complete. Do not extend it.
- **Why:** CA localization is otherwise identical to US standards.
- **Scope:** language en-CA · all markets (asserted by the source) (specificity 1)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Source:** `section Weitere markttypische Regeln, page 2`

### `market.availability_us_ca`

**[MUST]** Bewerben Sie dieses Produkt nicht in den USA und Kanada, da es dort nicht erhältlich ist.

- **Why:** Dieses Produkt ist nicht in den USA und Kanada erhältlich.
- **Scope:** product Nextcloud · all markets (asserted by the source) (specificity 8)
- **Slots:** unscoped — applies wherever this rule's scope matches.
- **Modality inferred:** the source had no modal verb. Treat with the corresponding caution when it conflicts with a stated one.
- **Source:** `section Zielmärkte, page 2`

### `navigation.us_ca_structure`

**[SHOULD]** For US/CA navigation, use the UK navigation structure as a baseline, applying US-specific spelling where it differs.

- **Caveat:** Orient strictly on the UK column as a general rule.
- **Exhaustive:** no — the source presents this as illustrative.
- **Why:** Source gap: US does not have its own column in the source table.
- **Scope:** language en-US (specificity 1)
- **Slots:** nav_label
- **Channels:** web
- **Human track only:** no prompt can satisfy this — it asks for an action outside text generation. Never inject it as an instruction.
...
**[MUST]** Use the live claim 'IVA incluido' for tax-inclusive pricing.
...
**[MUST]** Use 'IVA incluido' to indicate VAT-inclusive pricing.
