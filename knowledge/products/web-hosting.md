...
subject: knowledge/products/web-hosting.md
team: IONOS
...
### `ordinary_consumers` — Gewöhnliche Verbraucher

> **NOT TARGETED.** The source marks this segment out of focus — an instruction not to write for it, not a lower-priority segment to include anyway.

- Private Anwender mit Zwecken von Hochzeits-Websites über App-/Web-Entwicklung bis zur Zweckentfremdung als Online-Speicherplatz. Zielgruppe nicht im Fokus.
- **Share of cases:** 10%
- **Technical level:** variiert; auch technikaffine Kunden vertreten
- **Motivations:** günstiger Preis ist Hauptauslöser für Kauf; technikaffine Kunden schätzen die Funktionsvielfalt
- **Pain points:** Preissensitive Zielgruppe
- **Source:** `Comms Guide DE Web Hosting.md:34-38`

### `small_business` — Kleinunternehmen

- Kleinunternehmen, deren IT-Leiter über Hosting entscheidet; Grad an technischem Wissen kann stark variieren.
- **Share of cases:** 40%
- **Decision maker:** Leiter der IT
- **Technical level:** kann variieren
- **Motivations:** Skalierbarkeit/Wachstum
- **Pain points:** Benötigen einen zuverlässigen Geschäftspartner für technischen Support
- **Source:** `Comms Guide DE Web Hosting.md:27-32`

### `web_pros_agencies` — Profis: Agenturen/Web Profis

- Web-Profis und Agenturen, die bereits WordPress und andere CMS-Systeme nutzen und Webhosting für eigene Kunden weiterverkaufen.
- **Share of cases:** 50%
- **Decision maker:** Endbenutzer und Profis selbst
- **Technical level:** Nutzen bereits WordPress und andere CMS-Systeme
- **Motivations:** Zeitersparnis; Preis-Leistungs-Verhältnis; 24/7 Support
- **Source:** `Comms Guide DE Web Hosting.md:19-24`

## Shared audience segments (reusable across products)

Not specific to Web Hosting — these resolve the same `audience_segment` scope coordinate for any product. Full definitions in `knowledge/products/index.yaml`.

- `allgemeine_verbraucher` — Allgemeine Verbraucher
- `audience.agency_owner` — Agenturinhaber
- `audience.agenturen` — Agenturen
- `audience.agenturen_startups` — Agenturen/Start-ups
- `audience.agenturinhaber` — Agenturinhaber
- `audience.developers_small_teams` — Developers and Small Technical Teams
- `audience.domainer_investoren` — Domainer und Domain-Investoren
- `audience.entwickler` — Entwickler
- `audience.it_entscheider` — Der IT-Entscheider
- `audience.kleinstunternehmen` — Kleinstunternehmen
- `audience.kleinunternehmen` — Kleinunternehmen
- `audience.konsumenten_privatpersonen` — Konsumenten/Privatpersonen
- `audience.profis` — Profis: Agenturen/Web Profis
- `audience.small_business_and_freelance_pros` — Small business owners and freelance web professionals
- `audience.verbraucher` — Gewöhnliche Verbraucher — **NOT TARGETED**
- `audience.web_app_developer` — Web- und App-Entwickler
- `audience.webdesigner` — Webdesigner
- `audience.wordpress_hosting` — WordPress Hosting
- `audience.wordpress_pro` — WordPress Pro
- `beginners_and_small_businesses` — Einsteiger und kleine Unternehmen
- `developers_and_small_teams` — Developers and Small Technical Teams
- `einsteiger_kleinunternehmer` — Einsteiger und professionelle Kleinunternehmer
- `inexperienced_small_business_owners` — Kleinunternehmer ohne Erfahrung
- `kleinunternehmer` — Kleinunternehmer
- `kmu` — Kleine bis mittlere Unternehmen (KMU)
...
- `neue_unternehmen` — Neue Unternehmen / Start-ups
- `out_of_focus_customers` — Nicht geeignete Kunden — **NOT TARGETED**
- `reseller` — Reseller
- `smb_and_freelance_web_pros` — Small business owners and freelance web professionals
- `smb_local` — Sehr kleine bis mittelgroße Unternehmen (KMU)
- `target_audience.consumers` — Gewöhnliche Verbraucher — **NOT TARGETED**
- `target_audience.general` — Website-Ersteller ohne Zeit/Erfahrung
- `target_audience.kmu` — KMU
- `target_audience.out_of_focus` — Nicht geeignete Kunden — **NOT TARGETED**
- `target_audience.professionals` — Profis: Agenturen/Web Profis
- `target_audience.small_businesses` — Kleinunternehmen
- `target_audience.smb` — Kleine bis mittelgroße Unternehmen (KMU)
- `target_audience.smb_and_private` — Kleine bis mittelgroße Unternehmen, Selbständige und Privatpersonen
- `target_audience.smb_tech_savvy` — Selbstständige und kleine Unternehmen (Tech-savvy)
- `target_audience.smes_and_freelancers` — Kleinst- und Kleinunternehmer sowie Selbstständige
- `target_audience.vereine_verbaende` — Gesellschaften, Vereine und Verbände
- `target_audience.web_pros_agencies` — Web-Profis & Agenturen

## Benefit ladder

Each rung is the source's own row, in the source's own order: what the customer seeks, what IONOS offers against it, the functional payoff, the emotional payoff. The ladder IS the argument — do not emit rung 2 without rung 1.

### Rung 1

- **Customer seeks:** Einfache Anwendung
- **IONOS offers:** Schnelligkeit / Performance-optimierte Plattform
- **Functional benefit:** UX-Erfahrung auf der eigenen Website
- **Emotional benefit:** Gefühle von Erfolg und Belohnung
- **Audience:** applies across audience segments (not tied to one)
- **Source:** `Comms Guide DE Web Hosting.md:70-74`

### Rung 2

- **Customer seeks:** Verlässlichkeit
- **IONOS offers:** Professionalität / 25+ Jahre Hosting-Erfahrung
- **Functional benefit:** Verlässliches Hosting, das mit den Anforderungen des Traffic wächst
- **Emotional benefit:** Selbstbewusstsein, Motivation
- **Audience:** applies across audience segments (not tied to one)
- **Source:** `Comms Guide DE Web Hosting.md:70-74`

### Rung 3

- **Customer seeks:** Sicherheit
- **IONOS offers:** Strenge Datenschutzrichtlinien (EU), DSGVO-konform
- **Functional benefit:** Georedundanz, Schutz gegen DDoS-Attacken
- **Emotional benefit:** Ruhe, Gewissheit
- **Audience:** applies across audience segments (not tied to one)
- **Source:** `Comms Guide DE Web Hosting.md:70-74`

### Rung 4

- **Customer seeks:** Service / Support
- **IONOS offers:** 24/7 erreichbar, direkter Kontakt zum persönlichen Berater
- **Functional benefit:** Probleme jeder Art werden schnell gelöst
- **Emotional benefit:** Vertrauen, Unterstützung, das Gefühl von Partnerschaftlichkeit mit IONOS
- **Audience:** applies across audience segments (not tied to one)
- **Source:** `Comms Guide DE Web Hosting.md:70-74`
...
- **Local product name:** `Webhosting` — use this name in this market, not the global product name.
- **Strength tier:** lead
- **Notes:** US, UK, DE sind die stärksten Märkte.
- **Source:** `Comms Guide DE Web Hosting.md:95`

### ES

- **Availability:** available
- **Price sensitivity:** high
- **Notes:** ES ist der preissensibelste Markt.
- **Source:** `Comms Guide DE Web Hosting.md:95`
...
**Available in all markets.** The source asserts no special market segmentation for this product; do not read this as nine unreviewed rows.

- **Availability:** available
- **Notes:** Dieses Produkt ist in allen Märkten verfügbar. Es existiert keine spezielle Marktsegmentierung.
- **Source:** `Comms Guide DE Web Hosting.md:93`
