...
Partition key `8aa9afcc-f2bf-4388-9066-482448eaa32d` — pass this as `brand` to the Hub's API, and read only this directory.

14 atoms in this directory, 14 of them global on all four axes. Retired and draft
...
|---|---|---|
| [`image guidelines`](image-guidelines.md) | 14 | `photographic_style` 4, `composition_and_framing` 2, `subject_and_diversity` 4, `color_direction` 2, `visual_tokens` 1, `misc` 1 |
