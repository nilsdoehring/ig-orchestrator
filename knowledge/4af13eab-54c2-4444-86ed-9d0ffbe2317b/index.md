...
Partition key `4af13eab-54c2-4444-86ed-9d0ffbe2317b` — pass this as `brand` to the Hub's API, and read only this directory.

9 atoms in this directory, 9 of them global on all four axes. Retired and draft
...
|---|---|---|
| [`image guidelines`](image-guidelines.md) | 9 | `photographic_style` 3, `composition_and_framing` 2, `subject_and_diversity` 2, `visual_tokens` 1, `misc` 1 |
