...
subject: knowledge/statements/tagline.md
team: IONOS
...
- **Body (verbose register only):** Digital an Ihrer Seite
...
- **Body (verbose register only):** Your digital partner
- **Usage condition:** Primary brand tagline for CA market
...
- **Body (verbose register only):** Your digital partner
- **Usage condition:** Primary brand tagline for UK market
...
- **Body (verbose register only):** Your digital partner
- **Usage condition:** US market brand tagline
...
- **Body (verbose register only):** Tu solución digital
- **Usage condition:** Spanish market brand tagline
...
- **Body (verbose register only):** Tu solución digital
- **Usage condition:** Primary brand tagline for the MX market
...
- **Body (verbose register only):** Votre partenaire digital
- **Usage condition:** Primary brand tagline for the French market
...
- **Body (verbose register only):** Il tuo partner digitale
- **Usage condition:** Primary brand tagline for IT market
...
- **Body (verbose register only):** Digital an Ihrer Seite
- **Usage condition:** Wird sowohl zur Ansprache der SMB- als auch Pro-Audience genutzt.
- **Source:** `section Taglines, page 4`

### `brand.tagline_variant`

> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Brand Tagline Variante**

- **Body (verbose register only):** Wir sind digital an Ihrer Seite.
- **Usage condition:** Oft in direkter Rede beim Persönlichen Berater (PSA).
- **Source:** `section Taglines, page 4`

### `tagline.brand_tagline_de`
...
- **Body (verbose register only):** Digital an Ihrer Seite
- **Usage condition:** Grundform, ohne Punkt, außer die Tagline ist Teil eines Satzes oder einer Subline.
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:145`

**Ordinal 2**

> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Brand Tagline (Variante, direkte Rede)**

- **Body (verbose register only):** Wir sind digital an Ihrer Seite.
- **Usage condition:** in direkter Rede beim Persönlichen Berater/PSA
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:147`
