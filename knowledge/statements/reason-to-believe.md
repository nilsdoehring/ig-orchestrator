...
subject: knowledge/statements/reason-to-believe.md
team: IONOS
...
- **AI (compact):** Erster & größter Hoster, 30 Jahre, 6.5M+ Kunden
- **Human (verbose):** Der erste und größte Hoster – 30 Jahre, über 6,5 Mio. Kunden
- **Scope:** language de-DE (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **AI (compact):** Europe's first and largest host – Trusted for 30+ years by over 6.5M customers
- **Human (verbose):** Europe's first and largest host – Trusted for 30+ years by over 6.5 million customers
- **Usage condition:** Live trust claim for UK market
...
- **Body (verbose register only):** El proveedor más grande de hosting de Europa
- **Usage condition:** Trust claim for Spanish market
- **Scope:** language es-ES (specificity 1)
- **Source:** `section Markenregeln`
...
- **Body (verbose register only):** Premier hébergeur européen
- **Usage condition:** Live trust claim
- **Scope:** language fr-FR (specificity 1)
- **Source:** `section Markenregeln, page 1`

### `domains.included_features`

**Bei allen Domains inklusive**

- **AI (compact):** Inklusive Features: 2 GB E-Mail, Wildcard SSL, Ein-Klick-Einrichtung, Domain Lock und Weiterverkaufsoption.
- **Human (verbose):** Bei allen Domains inklusive: E-Mail-Postfach mit 2 GB Speicherplatz (erweiterbar), Sicherheit (Wildcard SSL-Zertifikat), Einfache Einrichtung (Ein-Klick-Aktivierung, Domain Connect), Domain Lock (Schutz vor unbefugtem Transfer), Weiterverkauf (Möglichkeit zum gewinnbringenden Verkauf).
- **Scope:** product Domains (specificity 8)
- **Source:** `section KSPs | Key Messages, page 2`

### `emotion_mapping.growth`

**Emotion Mapping: Unternehmenswachstum**

- **AI (compact):** Schnelle Ergebnisse bringen Zufriedenheit beim Wunsch nach Wachstum.
- **Human (verbose):** Wunsch nach Online-Präsenz für Unternehmenswachstum -> In kürzester Zeit und mit wenigen Klicks zur eigenen Website für das Unternehmen -> Zufriedenheitsgefühl durch schnelle Ergebnisse.
- **Scope:** product MyWebsite Now (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `emotion_mapping.no_coding`

**Emotion Mapping: Keine Programmierkenntnisse**

- **AI (compact):** Erleichterung durch Zeitersparnis und Verzicht auf Programmierkenntnisse.
- **Human (verbose):** Eine professionell aussehende Website inkl. Mail-Adresse etc. erhalten, ohne selbst programmieren und viel Zeit aufwenden zu müssen -> Anwenderfreundliche Nutzeroberfläche, Speicher, Software, weitere Extras. Der Kunde kann in unter 60 Minuten seine Website selbst erstellen. -> Erleichterung durch Zeitersparnis, weil keine neuen Kenntnisse (z.B. Programmieren) erlernt werden müssen oder die Aufgabe extern vergeben werden muss.
- **Scope:** product MyWebsite Now (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `emotion_mapping.professionalism`

**Emotion Mapping: Professionalität**

- **AI (compact):** Professionelle Themes stärken das Selbstbewusstsein.
- **Human (verbose):** Wunsch nach Online-Präsenz für ein professionelleres Gefühl -> Themes und Layouts für jeden Bereich, ob Unternehmen oder Hobby -> Selbstbewusstsein durch professionellen Internetauftritt.
- **Scope:** product MyWebsite Now (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `emotion_mapping.support`

**Emotion Mapping: Unterstützung**

- **AI (compact):** Erfolgserlebnis durch Eigenleistung gepaart mit Sicherheit durch 24/7-Support.
- **Human (verbose):** Selbständige Lösung der Herausforderung aber mit dem Wissen, dass eine gewisse Unterstützung vorhanden ist -> Erstellung der Website erfolgt in Eigenregie, Unterstützung durch einen Experten steht aber rund um die Uhr und an sieben Tagen die Woche zur Verfügung. -> Erfolgserlebnisse durch eigene Leistung und Sicherheit dank optionaler Unterstützung.
- **Scope:** product MyWebsite Now (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `key_message.customer_service`

**Kundenservice**

- **AI (compact):** Rund um die Uhr erreichbarer persönlicher Berater
- **Human (verbose):** 24/7, Unterstützung durch einen persönlichen Berater
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `key_message.easy_use`

**Einfache Anwendung**

- **AI (compact):** Unkomplizierte 1-Klick-Installation inklusive Domain, E-Mail und SSL
- **Human (verbose):** 1-Klick-Installation, inkl. vieler zusätzlicher Features (Domains, Email, SSL). Webhosting ist keine 'einfache' Lösung ohne technische Kenntnisse, aber verglichen mit Server-Produkten unkomplizierter, da Instandhaltung und Updates entfallen.
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `key_message.green_energy`

**Grüne Energie**

- **AI (compact):** Umweltfreundliches Hosting mit grüner Energie
- **Human (verbose):** Grüne Energie (Abhängig von der Verfügbarkeit im Zielmarkt. Am relevantesten für die Zielgruppe des WordPress Hosting, wo Kreative die größte Zielgruppe bilden.)
- **Usage condition:** Abhängig von Marktverfügbarkeit; besonders relevant für WordPress-Hosting/Kreative
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 2`

### `key_message.personal_consultant`

**Maßgeschneiderte Beratung**

- **AI (compact):** Persönlicher Berater für individuelle Fragen zum Onlineshop und Online-Erfolg.
- **Human (verbose):** Maßgeschneiderte Beratung: Jeder Kunde erhält einen persönlichen Berater, der ihm Fragen zu seinem Onlineshop und den Erfolgsfaktoren im Netz beantwortet.
- **Scope:** product Social Buy Button (specificity 8)
- **Source:** `section Kernaussagen, page 1`

### `key_message.security_reliability`

**Sicherheit und Verlässlichkeit**

- **AI (compact):** Höchste Sicherheit durch DDoS-Schutz, Georedundanz und ISO-Zertifizierung
- **Human (verbose):** Malware + DDoS-Schutz, Georedundanz, ISO-zertifizierte Rechenzentren, Backups, branchenführende Betriebszeiten
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Maximale Performance durch SSD, Glasfaser und CDN
- **Human (verbose):** SSD-Speicher, Hochgeschwindigkeits-Glasfaserverbindungen für Rechenzentren, Content Delivery Network (CDN)
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** 24/7 Support durch persönlichen Berater
- **Human (verbose):** 24/7, Unterstützung durch einen persönlichen Berater
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
**KSP 3: Individuelle Tipps durch Crawling**

- **AI (compact):** Individual tips tailored to the specific website, generated via crawling.
- **Human (verbose):** Individuelle Tipps speziell für die jeweilige Unternehmenswebsite, generiert durch das Crawlen der Website.
...
- **AI (compact):** Sicherheit und Verlässlichkeit durch Georedundanz und ISO-Zertifizierung
- **Human (verbose):** Malware + DDoS-Schutz, Georedundanz, ISO-zertifizierte Rechenzentren, Backups, branchenführende Betriebszeiten
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Schnelligkeit durch SSD und CDN
- **Human (verbose):** SSD-Speicher, Hochgeschwindigkeits-Glasfaserverbindungen für Rechenzentren, Content Delivery Network (CDN)
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `ksp.ultra_flexible_design`

**Ultra-flexibles Design**

- **AI (compact):** Erstellen ohne Design-Einschränkungen dank CSS/HTML-Bearbeitung und Drittanbieter-Apps.
- **Human (verbose):** Ultra-flexibles Design: Benutzer können erstellen und bauen, was sie wollen, ohne Design-Einschränkungen. Sie können mittels CSS und HTML Seiten bearbeiten sowie Apps von Drittanbietern integrieren.
- **Scope:** product MyWebsite Creator eCommerce (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `ksp_sicherheit_und_verlaesslichkeit`

**KSP: Sicherheit und Verlässlichkeit**

- **AI (compact):** ISO-zertifizierte Datenzentren, SSL-Zertifikat und Anti-Spam-Filter garantieren Sicherheit.
- **Human (verbose):** Sicherheit und Verlässlichkeit durch ISO-zertifizierte Datenzentren, SSL-Zertifikat und Anti-Spam-Filter.
- **Scope:** product E-Mail (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `motivation.growth`

**Motivation: Unternehmenswachstum**

- **AI (compact):** Schnelle Ergebnisse führen zu Zufriedenheit beim Wunsch nach Wachstum.
- **Human (verbose):** Wunsch nach Online-Präsenz für Unternehmenswachstum: In kurzer Zeit und mit wenigen Klicks zur eigenen Website für das Unternehmen führt zu einem Zufriedenheitsgefühl durch schnelle Ergebnisse.
- **Scope:** product MyWebsite Creator (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `motivation.independence_with_support`

**Motivation: Eigenregie mit Support-Sicherheit**

- **AI (compact):** Eigenständiges Designen mit der Sicherheit eines 24/7 Experten-Supports im Hintergrund.
- **Human (verbose):** Selbständige Lösung der Herausforderung mit dem Wissen, dass Unterstützung vorhanden ist: Erstellung der Website erfolgt in Eigenregie, unterstützt durch granulare Designmöglichkeiten und die Sicherheit eines 24/7 Experten-Supports, was zu Erfolgserlebnissen und Sicherheit führt.
- **Scope:** product MyWebsite Creator (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `motivation.no_coding`

**Motivation: Keine Programmierkenntnisse nötig**

- **AI (compact):** Zeitersparnis und Erleichterung, da keine Programmierkenntnisse erlernt werden müssen.
- **Human (verbose):** Eine professionell aussehende Website inkl. Mail-Adresse erhalten, ohne selbst programmieren und viel Zeit aufwenden zu müssen: Anwenderfreundliche Nutzeroberfläche dank Drag-and-Drop ermöglicht eine maßgeschneiderte Website und bringt Erleichterung durch Zeitersparnis.
- **Scope:** product MyWebsite Creator (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `motivation.professionalism`

**Motivation: Professionelles Auftreten**

- **AI (compact):** Professionelle Themes verleihen Selbstbewusstsein für den Internetauftritt.
- **Human (verbose):** Wunsch nach Online-Präsenz für ein professionelleres Auftreten: Themes und Layouts für jeden Bereich, ob Unternehmen oder Hobby, verleihen Selbstbewusstsein durch einen professionellen Internetauftritt.
- **Scope:** product MyWebsite Creator (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `reason_to_believe.reasons`
...
- **Body (verbose register only):** We've been engineering infrastructure and applications at scale for over 25 years.
- **Source:** `ionos - brand identity and voice.md:51`

**Ordinal 2**

**Service Champions**

- **Body (verbose register only):** Our powerful solutions are backed by outstanding support and service.
- **Source:** `ionos - brand identity and voice.md:54`

**Ordinal 3**

**Trusted Leader**

- **Body (verbose register only):** We're a leading provider in Europe with millions of customers worldwide.
- **Source:** `ionos - brand identity and voice.md:56`

### `rtb.by_devs_for_devs`

**Von Developern für Developer**

- **AI (compact):** Developed by a team of developers who use the product daily and welcome feedback.
- **Human (verbose):** Von Developern für Developer entwickelt: Deploy Now wurde von einem Team entwickelt, das das Produkt selbst täglich nutzt. Feedback von Entwicklern, die mit GitHub oder anderen Plattformen arbeiten, ist mehr als willkommen und wird gerne umgesetzt.
...
- **AI (compact):** Over 25 years of engineering infrastructure and applications at scale.
- **Human (verbose):** We’ve been engineering infrastructure and applications at scale for over 25 years.
- **Source:** `section Reason to believe, page 1, line 46`

### `rtb.reliable_infrastructure`

**Verlässliche Infrastruktur**

- **AI (compact):** Projects are hosted on IONOS's green, redundant hosting network.
- **Human (verbose):** Gesichert durch eine verlässliche Infrastruktur: Projekte werden in einem grünen, redundanten Hosting-Netzwerk von IONOS aufgesetzt.
- **Scope:** product Deploy Now (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `rtb.service_champions`

**RTB: Service Champions**

- **AI (compact):** Powerful solutions backed by outstanding support and service.
- **Human (verbose):** Our powerful solutions are backed by outstanding support and service.
- **Source:** `section Reason to believe, page 1, line 48`

### `rtb.trusted_leader`

**RTB: Trusted Leader**

- **AI (compact):** A leading provider in Europe with millions of customers worldwide.
- **Human (verbose):** We’re a leading provider in Europe with millions of customers worldwide.
- **Source:** `section Reason to believe, page 1, line 50`

### `server.cloud_server.features`

**Features Cloud Server**

- **AI (compact):** VMware-Virtualisierung, SAN-SSD, Pay-as-you-go, unbegrenzter Traffic, kostenlose Load Balancer, Shared/Block Storage, Backups und Imaging.
- **Human (verbose):** VMware-virtualisierte Public-Cloud-Infrastruktur mit SAN-SSD-Speicher; Volle Flexibilität und Skalierbarkeit der Plattform (Pay-as-you-go-Abrechnung); Unbegrenzter Traffic; Features wie kostenlose Load Balancer, Shared Storage, Block Storage, Backups und Server Imaging
- **Scope:** product Cloud Server (specificity 8)
- **Source:** `section Kernaussagen, page 1`

### `server.dedicated_server.features`

**Features Dedicated Server**

- **AI (compact):** Keine Vertragsbindung, neueste Hardware, Pay-as-you-go, unbegrenzter Traffic, kostenlose Load Balancer, Shared/Block Storage, Imaging und Backups.
- **Human (verbose):** Keine Vertragsbindung (Pay-as-you-go-Abrechnung); Portfolio mit der neuesten Hardware/Prozessortechnik (wo immer möglich); Volle Flexibilität: alle Server und Dienste werden nach Bedarf bezahlt und abgerechnet, ohne Vertragsbindung; Unbegrenzter Traffic; Funktionen wie kostenlose Load Balancer, Shared Storage, Block Storage, Server Imaging und Backups
...
- **AI (compact):** Einfaches Upgrade auf Shoplement für ein vollwertiges Multi-Channel-Erlebnis.
- **Human (verbose):** Wenn das nicht mehr ausreicht, kann der Social Buy Button einfach auf Shoplement aufgerüstet werden, das auf jeder Website genutzt werden kann. So ist es unseren Kunden möglich, ein Multi-Channel-Erlebnis zu schaffen.
- **Scope:** product Social Buy Button (specificity 8)
- **Source:** `section Bedürfnisse/Kundenprobleme, page 1`

### `wordpress.emotion.community`

**Emotion: Community**

- **AI (compact):** Unterstützung durch eine große Open-Source-Community.
- **Human (verbose):** Community: Große Open-Source-Community
- **Scope:** product WordPress Hosting (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `wordpress.emotion.popularity`

**Emotion: Beliebtheit**

- **AI (compact):** WordPress ist mit 64 % Marktanteil das weltweit meistgenutzte CMS.
- **Human (verbose):** Beliebtheit: 64 % der CMS-basierten Websites sind mit WordPress erstellt, dem weltweit meistgenutzten Content-Management-System für das Erstellen von Websites
- **Scope:** product WordPress Hosting (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `wordpress.emotion.support`

**Emotion: Persönliche Beratung**

- **AI (compact):** Persönlicher Berater rund um die Uhr an 7 Tagen die Woche erreichbar.
- **Human (verbose):** Persönliche Beratung: An sieben Tagen die Woche steht rund um die Uhr ein persönlicher Berater zur Verfügung
- **Scope:** product WordPress Hosting (specificity 8)
- **Source:** `section Emotionen | Wahrnehmung, page 1`

### `wordpress.ksp.support`

**KSP: Persönliche Beratung**

- **AI (compact):** 24/7 WordPress-Experten-Support an sieben Tagen die Woche.
- **Human (verbose):** Persönliche Beratung: Unser WordPress-Experten-Support ist rund um die Uhr und an sieben Tagen die Woche verfügbar
- **Scope:** product WordPress Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
