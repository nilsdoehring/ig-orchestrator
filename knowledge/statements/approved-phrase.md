...
subject: knowledge/statements/approved-phrase.md
team: IONOS
...
### `approved_phrase.cta_generic_phrases`
...
- **Body (verbose register only):** Mehr erfahren
- **Usage condition:** Generisch einsetzbare CTA-Formulierung
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:324`
...
- **Body (verbose register only):** Alle Infos
- **Usage condition:** Generisch einsetzbare CTA-Formulierung
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:324`
...
- **Body (verbose register only):** Jetzt entdecken
- **Usage condition:** Generisch einsetzbare CTA-Formulierung
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:324`
...
- **Body (verbose register only):** Jetzt starten
- **Usage condition:** Generisch einsetzbare CTA-Formulierung
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:324`
...
- **Body (verbose register only):** 100 % DSGVO-konform
- **Scope:** language de-DE (specificity 1)
...
- **Body (verbose register only):** RGPD
- **Usage condition:** GDPR claim for Spanish market
...
- **Body (verbose register only):** LFPDPPP
- **Usage condition:** Live privacy law claim for the MX market
...
- **Body (verbose register only):** 100% GDPR-compliant
- **Usage condition:** Live GDPR claim for UK market
- **Scope:** language en-GB (specificity 1)
- **Source:** `section Markenregeln, page 1`

### `brand.meta_title_pattern`
...
> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Meta-Title-Muster (Live)**

- **Body (verbose register only):** IONOS | Von Website bis Cloud » Digital an Ihrer Seite
- **Usage condition:** Meta-Title
- **Scope:** language de-DE (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** IONOS | Hosting, cloud, dominios y páginas web
- **Usage condition:** Live Meta Title pattern for the MX market
- **Scope:** language es-MX (specificity 1)
- **Source:** `section Markenregeln`

### `brand.money_back_claim`
...
- **Body (verbose register only):** 30 Tage Geld-zurück-Garantie
- **Scope:** language de-DE (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** 30-day money-back guarantee
- **Usage condition:** Live money-back claim for UK market
- **Scope:** language en-GB (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** 30 días de garantía
- **Usage condition:** Money back guarantee claim for Spanish market
- **Scope:** language es-ES (specificity 1)
- **Source:** `section Markenregeln`
...
- **Body (verbose register only):** 30 jours satisfait ou remboursé
- **Usage condition:** Live money-back claim
...
- **AI (compact):** 24/7 Support & persönlicher Berater
- **Human (verbose):** 24/7 Experten-Support – Ihr persönlicher Berater
- **Scope:** language de-DE (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** 24/7 expert support – plus a personal consultant
- **Usage condition:** Live support claim for UK market
- **Scope:** language en-GB (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** Atención 24/7
- **Usage condition:** Support claim for Spanish market
- **Scope:** language es-ES (specificity 1)
- **Source:** `section Markenregeln`
...
- **Body (verbose register only):** Support 24h/24, 7j/7
- **Usage condition:** Live support claim
- **Scope:** language fr-FR (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** 100% GDPR-compliant
- **Usage condition:** US market GDPR claim
...
- **Body (verbose register only):** 100% GDPR-compliant
- **Usage condition:** Live GDPR claim for CA market
...
- **Body (verbose register only):** IONOS | Hosting Provider: Domains, Websites, Servers.
- **Usage condition:** Live Meta Title for US market
- **Scope:** language en-US (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** IONOS » E-mail, dominios y páginas web
- **Usage condition:** Meta title pattern for Spanish market
- **Scope:** language es-ES (specificity 1)
- **Source:** `section Markenregeln`

### `seo.meta_title_pattern`
...
- **Body (verbose register only):** IONOS | Hosting Provider: Domains, Websites, Servers.
- **Usage condition:** Live Meta-Title pattern for CA market
- **Scope:** language en-CA (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** IONOS | Websites, Hosting, Domains
- **Usage condition:** Live meta title pattern for UK market
- **Scope:** language en-GB (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** IONOS | Hébergeur Web » Cloud, domaines et sites Internet
- **Usage condition:** Live meta title pattern
- **Scope:** language fr-FR (specificity 1)
- **Source:** `section Markenregeln, page 1`
...
- **Body (verbose register only):** Plus applicable tax
- **Usage condition:** Live tax claim for CA market
- **Scope:** language en-CA (specificity 1)
