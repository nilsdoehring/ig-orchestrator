...
subject: knowledge/statements/product-tagline.md
team: IONOS
...
>
**Produkt-Tagline (Live)**

- **Body (verbose register only):** Domain. Website. Cloud.
...
- **Body (verbose register only):** Websites · Domains · Cloud
- **Usage condition:** Live product tagline for UK market
...
- **Body (verbose register only):** Páginas web. Dominios. Cloud
- **Usage condition:** Live product tagline for the MX market
...
- **Body (verbose register only):** Domaines · Sites Web · Cloud
- **Usage condition:** Live product tagline
- **Scope:** language fr-FR (specificity 1)
- **Source:** `section Markenregeln, page 1`

### `product.tagline`

5 members, in ordinal order:
...
- **Body (verbose register only):** Websites · Domains · Servers
- **Usage condition:** Live product tagline for CA market
...
- **Body (verbose register only):** Websites · Domains · Servers
- **Usage condition:** Live product tagline for US market
...
- **Body (verbose register only):** Páginas web. Dominios. Cloud
- **Usage condition:** Spanish market product tagline
...
- **Body (verbose register only):** E-mail, domini e siti web
- **Usage condition:** Live product tagline for IT market
...
> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Produkt-Tagline Grundvariante**

- **Body (verbose register only):** Domain. Website. Cloud.
- **Usage condition:** Standard-Produktfokus.
...
> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Produkt-Tagline Pro-Variante**

- **Body (verbose register only):** Hosting. Server. Cloud.
- **Usage condition:** Für die Pro Audience angepasst.
- **Source:** `section Taglines, page 4`

### `product_tagline.base`
...
- **Body (verbose register only):** Domain. Website. Cloud.
- **Usage condition:** Grundvariante
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:159-160`

**Ordinal 2**

> **VERBATIM — USE EXACTLY, NEVER PARAPHRASE.**
>
**Produkt-Tagline (Produktfokus-Variante)**

- **Body (verbose register only):** Hosting. Server. Cloud.
- **Usage condition:** Je nach Produktfokus austauschbar; öfter für die Pro-Audience genutzt.
- **Scope:** language de-DE (specificity 1)
- **Source:** `Style Guide DEU.md:162-164`
