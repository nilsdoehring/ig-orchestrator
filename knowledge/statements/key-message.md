...
subject: knowledge/statements/key-message.md
team: IONOS
...
- **AI (compact):** Rund um die Uhr persönlicher Support
...
- **AI (compact):** Einfache 1-Klick-Installation inklusive Domain, E-Mail und SSL
- **Human (verbose):** Einfache Anwendung: 1-Klick-Installation, inkl. vieler zusätzlicher Features (Domains, Email, SSL). Webhosting ist unkomplizierter als ein Server-Produkt, da Instandhaltung, Pflege und Updates entfallen.
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Nachhaltiges Hosting mit grünem Strom
- **Human (verbose):** Grüne Energie
- **Usage condition:** Abhängig von der Verfügbarkeit im Zielmarkt. Am relevantesten für WordPress Hosting (Kreative).
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `key_message.scalable_performance`

**Skalierbare Performance-Level**

- **AI (compact):** Flexibel erweiterbarer Speicherplatz
- **Human (verbose):** Skalierbare Performance-Level: Nutzer können Speicherplatz hinzufügen, falls benötigt
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`

### `key_message.security`

**KSP 1: Sicherheit und Verlässlichkeit**

- **AI (compact):** Höchste Sicherheit durch Malware-Schutz, Georedundanz und ISO-zertifizierte Rechenzentren.
...
- **AI (compact):** Höchste Sicherheit und Verlässlichkeit durch Georedundanz und ISO-Zertifizierung
- **Human (verbose):** Sicherheit und Verlässlichkeit: Malware + DDoS-Schutz, Georedundanz, ISO-zertifizierte Rechenzentren, Backups, branchenführende Betriebszeiten
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Maximale Geschwindigkeit dank SSD, Glasfaseranbindung und CDN.
...
### `key_message.value_for_money`

**Gutes Preis-Leistungs-Verhältnis**

- **AI (compact):** Hervorragendes Preis-Leistungs-Verhältnis
- **Human (verbose):** Gutes Preis-Leistungs-Verhältnis
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Rund um die Uhr Support durch einen persönlichen Berater.
- **Human (verbose):** Kundenservice: 24/7, Unterstützung durch einen persönlichen Berater
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Maximale Sicherheit durch Georedundanz, DDoS-Schutz und ISO-Zertifizierung.
- **Human (verbose):** Sicherheit und Verlässlichkeit: Malware + DDoS-Schutz, Georedundanz, ISO-zertifizierte Rechenzentren, Backups, branchenführende Betriebszeiten
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
...
- **AI (compact):** Highspeed-Performance dank SSD, Glasfaser und CDN.
- **Human (verbose):** Schnelligkeit: SSD-Speicher, Hochgeschwindigkeits-Glasfaserverbindungen für Rechenzentren, Content Delivery Network (CDN)
- **Scope:** product Web Hosting (specificity 8)
- **Source:** `section KSPs | Key Messages, page 1`
