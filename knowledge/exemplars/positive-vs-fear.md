...
subject: knowledge/exemplars/positive-vs-fear.md
team: IONOS
...
# Pair group: `positive_vs_fear`

4 don'ts, 5 dos. Donts come first so the contrast reads in one pass — a do/don't pair is a single teaching unit, not two independent examples.

### Don't — `exemplar.fear_based`

- **body_text:** Wenn Sie Ihre Idee nicht online präsentieren, wird Ihnen jemand zuvorkommen.
...
- **Source excerpt:** Wenn Sie Ihre Idee nicht online präsentieren, wird Ihnen jemand zuvorkommen.
- **Slots:** body_text
- **Illustrates rule:** `tone.attitude`
- **Source:** `section So soll es klingen | So nicht, page 2`

### Don't — `exemplar.positive_vs_fear.dont`

- **body_text:** Wenn Sie Ihre Idee jetzt nicht online bringen, wird es jemand anderes tun.

**Why:**
- Angst-Marketing

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Wenn Sie Ihre Idee jetzt nicht online bringen, wird es jemand anderes tun.
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_positive`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`

### Don't — `tone.exemplar.positive_messages_dont`

- **body_text:** Wenn Sie Ihre Idee nicht online präsentieren, wird es jemand anderes tun.

**Why:**
- Angst-basierte Marketingbotschaft, negativ

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Wenn Sie Ihre Idee nicht online präsentieren, wird es jemand anderes tun.
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_and_positive`
- **Source:** `section Tonalität, page 1`

### Don't — `tone.exemplar.positive_vs_fear_dont`

- **body_text:** Wenn Sie nicht anfangen, Google Workspace zu nutzen, werden Sie den Anschluss verlieren und Ihre Arbeit wird ineffizient sein, was Sie auf lange Sicht kosten wird.
...
- **Source excerpt:** Wenn Sie nicht anfangen, Google Workspace zu nutzen, werden Sie den Anschluss verlieren und Ihre Arbeit wird ineffizient sein, was Sie auf lange Sicht kosten wird. → Angst-basiertes Marketing
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_and_positive`
- **Source:** `section Tone of Voice, page 3`

### Do — `exemplar.positive_benefit`

- **body_text:** Stärken Sie Ihre Marke und vergrößern Sie Ihren Kundenkreis mithilfe einer professionellen Website.

**Why:**
- Positive, vorteilsorientierte Aussagen

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Stärken Sie Ihre Marke und vergrößern Sie Ihren Kundenkreis mithilfe einer professionellen Website.
- **Slots:** body_text
- **Illustrates rule:** `tone.attitude`
- **Source:** `section So soll es klingen | So nicht, page 2`

### Do — `exemplar.positive_marketing`

- **body_text:** Stärken Sie Ihre Marke und vergrößern Sie Ihren Käuferkreis mit einem Onlineshop.

**Why:**
- Positiv, Fokus auf Vorteile

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Stärken Sie Ihre Marke und vergrößern Sie Ihren Käuferkreis mit einem Onlineshop.
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_positive`
- **Source:** `section So soll es klingen So nicht, page 1`

### Do — `exemplar.positive_vs_fear.do`

- **body_text:** Stärken Sie Ihre Marke und erweitern Sie Ihren Kundenstamm mit einem Onlineshop.

**Why:**
- Positive Botschaft, nutzenorientiert

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Stärken Sie Ihre Marke und erweitern Sie Ihren Kundenstamm mit einem Onlineshop.
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_positive`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`

### Do — `tone.exemplar.positive_messages`

- **body_text:** Stärken Sie Ihre Marke und vergrößern Sie Ihren Kundenkreis mithilfe einer professionellen Website.

**Why:**
- Positive, vorteilsorientierte Botschaften
...
### Do — `tone.exemplar.positive_vs_fear`

- **body_text:** Verbessern Sie Ihre Produktivität mit der intuitiven Lösung von Google.

**Why:**
- Positive Botschaft, die den Nutzen in den Mittelpunkt stellt

- **Fidelity: normalised** — the stored text was tidied from its source excerpt (whitespace, punctuation). See the source excerpt below for the raw form.
- **Source excerpt:** Verbessern Sie Ihre Produktivität mit der intuitiven Lösung von Google. → Positive Botschaft, die den Nutzen in den Mittelpunkt stellt
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_and_positive`
- **Source:** `section Tone of Voice, page 3`
