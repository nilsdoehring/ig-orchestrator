...
subject: knowledge/exemplars/testimonials-vs-hype.md
team: IONOS
...
# Pair group: `testimonials_vs_hype`

4 don'ts, 4 dos. Donts come first so the contrast reads in one pass — a do/don't pair is a single teaching unit, not two independent examples.

### Don't — `exemplar.hype_communication`

- **body_text:** Fügen Sie einen professionell aussehenden, benutzerfreundlichen Kauf-Button auf Facebook und Instagram hinzu! Ihre Kunden werden dieses großartige, einzigartige, unvergleichliche Kauferlebnis absolut LIEBEN!

**Why:**
- Zu viele Adjektive, übertrieben, zu viele Ausrufezeichen.

- **Fidelity: normalised** — the stored text was tidied from its source excerpt (whitespace, punctuation). See the source excerpt below for the raw form.
- **Source excerpt:** Fügen Sie einen professionell aussehenden, benutzerfreundlichen Kauf-Button auf Facebook und Instagram hinzu! Ihre Kunden werden dieses großartige, einzigartige, unvergleichliche Kauferlebnis absolut LIEBEN! → Zu viele Adjektive, übertrieben, zu viele Ausrufezeichen.
- **Slots:** body_text
- **Illustrates rule:** `tone.no_buzzwords_or_cliches`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`

### Don't — `exemplar.testimonials_vs_hype.dont`

- **body_text:** Erstellen Sie einen professionell aussehenden, voll funktionstüchtigen, benutzerfreundlichen Onlineshop, den Ihre Kunden absolut LIEBEN werden!

**Why:**
- Zu viele Adjektive, Übertreibung, Ausrufezeichen

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Erstellen Sie einen professionell aussehenden, voll funktionstüchtigen, benutzerfreundlichen Onlineshop, den Ihre Kunden absolut LIEBEN werden!
- **Slots:** body_text
- **Illustrates rule:** `tone.avoid_cliches`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`

### Don't — `exemplar.tone.testimonials_vs_hype_dont`

- **body_text:** Holen Sie sich jetzt Ihr IONOS E-Mail-Postfach! Indem Sie die Kommunikation mit Ihren Kunden auf ein neues Level bringen, können Sie Ihren Unternehmenswachstum signifikant vorantreiben.
...
- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Holen Sie sich jetzt Ihr IONOS E-Mail-Postfach! Indem Sie die Kommunikation mit Ihren Kunden auf ein neues Level bringen, können Sie Ihren Unternehmenswachstum signifikant vorantreiben.
- **Slots:** body_text
- **Illustrates rule:** `tone.avoid_cliches`
- **Source:** `section Tonalität, page 1`

### Don't — `exemplar.too_many_adjectives`

- **body_text:** Erstellen Sie eine professionelle, voll funktionsfähige und nutzerfreundliche Website, die die Besucher absolut lieben werden!

**Why:**
- Zu viele Adjektive, Übertreibungen, Ausrufezeichen

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Erstellen Sie eine professionelle, voll funktionsfähige und nutzerfreundliche Website, die die Besucher absolut lieben werden!
- **Slots:** body_text
- **Illustrates rule:** `tone.avoid_marketing_speak`
- **Source:** `section So soll es klingen | So nicht, page 2`

### Do — `exemplar.testimonials`

- **body_text:** Viele IONOS Kunden haben bereits erfolgreich eine eigene Website erstellt. Lesen Sie hier ihre Erfahrungsberichte.

**Why:**
- Testimonials erhöhen die Glaubwürdigkeit unserer Aussagen

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Viele IONOS Kunden haben bereits erfolgreich eine eigene Website erstellt. Lesen Sie hier ihre Erfahrungsberichte.
- **Slots:** body_text
- **Illustrates rule:** `tone.attitude`
- **Source:** `section So soll es klingen | So nicht, page 2`

### Do — `exemplar.testimonials_vs_hype.do`

- **body_text:** Viele IONOS Kunden haben ihr Geschäft bereits mit einem Onlineshop auf die digitale Bühne gebracht. Hier sind ihre Geschichten.

**Why:**
- Testimonials erhöhen die Glaubwürdigkeit unserer Botschaften

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Viele IONOS Kunden haben ihr Geschäft bereits mit einem Onlineshop auf die digitale Bühne gebracht. Hier sind ihre Geschichten.
- **Slots:** body_text
- **Illustrates rule:** `tone.focus_assets`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`

### Do — `exemplar.tone.testimonials`

- **body_text:** Viele unserer Kunden nutzen den E-Mail-Service von IONOS bereits – lesen Sie hier ihre Erfahrungsberichte.

**Why:**
- Testimonials erhöhen die Glaubwürdigkeit unserer Aussagen

- **Fidelity: verified** — `source_excerpt` matched `content` byte for byte at write time. A mechanical check, not a promise the content is right — see the source excerpt below for what the document actually said.
- **Source excerpt:** Viele unserer Kunden nutzen den E-Mail-Service von IONOS bereits – lesen Sie hier ihre Erfahrungsberichte.
- **Slots:** body_text
- **Illustrates rule:** `tone.honest_and_positive`
- **Source:** `section Tonalität, page 1`

### Do — `exemplar.use_testimonials`

- **body_text:** Viele IONOS-Kunden haben bereits einen Social Buy Button in ihren sozialen Medien eingerichtet. Lesen Sie ihre Geschichten.

**Why:**
- Testimonials erhöhen die Glaubwürdigkeit unserer Botschaften

- **Fidelity: normalised** — the stored text was tidied from its source excerpt (whitespace, punctuation). See the source excerpt below for the raw form.
- **Source excerpt:** Viele IONOS-Kunden haben bereits einen Social Buy Button in ihren sozialen Medien eingerichtet. Lesen Sie ihre Geschichten. → Testimonials erhöhen die Glaubwürdigkeit unserer Botschaften
- **Slots:** body_text
- **Illustrates rule:** `tone.focus_visuals_testimonials`
- **Source:** `section Das funktioniert / Das funktioniert nicht, page 1`
